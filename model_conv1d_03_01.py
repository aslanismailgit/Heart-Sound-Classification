...
shortDisc = "10000x1 Standardized conv1d ksize 9 Flatten No dense after convs "
y_pred_prob_test = model.predict([x_test])
modelname = ""
filename = os.path.basename(__file__)
DataSource = "Test"
performance_te, temp_te = get_results (DataSource, shortDisc, model, y_pred_prob_test,y_test,ind_test,recordPiece, fname, modelname,filename)
...
DataSource = "Val"
performance_val, temp_val = get_results (DataSource, shortDisc, model, y_pred_prob_val,y_val,ind_val,recordPiece, fname, modelname,filename)

#%
y_pred_prob_train = model.predict(x_train)
DataSource = "Train"
performance_tr, temp_tr  = get_results (DataSource, shortDisc, model, y_pred_prob_train,y_train, ind_train,recordPiece, fname, modelname,filename)
